#!/usr/bin/env python3
"""Equivalence policy `valid` for the Morris variant, opening phase, White to move.
...
Pass when:
  ...
  4. nothing else. The estimate is not compared: this category only asks that the
     program stays legal and well formed on these positions.
"""
import json
import re
import sys
...
MODE = "valid"        # "estimate", "ab" or "valid"
