...
1. Developed with OpenCode on my laptop against a local `qwen2.5-coder:14b`, the same setup as the reference harness. First working run of the reference harness was day 3 (the Ollama pull took an evening).
