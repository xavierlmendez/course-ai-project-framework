...
1. Developed with OpenCode on the shared Ollama server (qwen2.5-coder:14b) from day 2; used Gemini CLI for a first draft on day 1 but switched once the reference setup worked.
