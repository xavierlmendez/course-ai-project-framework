...
Developed with OpenCode + qwen3:14b on my laptop (16 GB). First working run of the reference harness on day 2. I fetched the resource page through the harness; it signed the ledger on the first try once I gave it my ID.
